  ...
  const proyectos = [
    {
      title: "Mendoza News",
      desciption:
        "Proyecto realizado para un portal de noticias de la provincia de Mendoza,Argentina ,donde trabaje especificamente en la parte del front, consumiendo apis(mostrando,enviando y eliminando datos desde la parte del admin),y trabajando en hacer el sitio web responsive",
    ...
    },
    {
        title: "Github Search",
      desciption:
        "En este proyecto me ocupe basicamente de consumir los distintos endpoints de la api de Github para poder buscar el usuario que se quiera obtener y mostrar toda la informacion de cada usuario",
