        ...
        <div id='inicio' className='parabg'>
            ...
            >
                ...
                <div className='flex flex-col p-2 gap-2 ' >
                    ...
                    <motion.p
                        className='w-full full text-center font-normal block md:hidden'
                        initial={{ opacity: 0 }}
                    ...
                    <div className='w-full  flex  flex-col justify-center items-center md:justify-start md:items-center md:w-full md:mt-0 md:mb-0'>
                        ...
                        <div className='w-full md:flex md:flex-row-reverse gap-36' >
                            <div className='w-full md:w-1/3 flex flex-col justify-center items-center animate-fade-in-right'>
                                ...
                                <div className='mb-8 flex flex-col relative md:w-full w-1/2  '>

                                    <motion.p
                                        className='w-full full pb-2 text-center font-normal md:mb-0 md:text-center md:text-2xl hidden md:block md:w-full '
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1, transition: { delay: 0.6, duration: 0.8 } }}
                                    >
                                        Full Stack Developer
                                ...
                                <img className='w-1/2 md:w-2/3 shadow-lg' src={img} alt="" />
                                <button className='bg-blue-500 text-xs p-2 md:text-base hover:bg-blue-800 mt-3 text-white md:font-bold md:py-2 md:px-4 rounded animate-pulse' color="success" onClick={handleOpen}>Contactame</button>
                            </div>
                            <Modal
                                keepMounted
                                open={open}
