...
export default function MediaCard({ title, description, url, index }) {
  ...
  return (
    <ScrollAnimation>
      <div className='flex-col md:flex-row md:w-full rounded-sm flex gap-4  p-2 border  border-blue-300 relative overflow-hidden transform transition-transform duration-300 hover:scale-95'>
